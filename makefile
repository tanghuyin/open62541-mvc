server.exe: server.o myNS.o open62541.o utils.o
	gcc -std=c99 -o server.exe server.o myNS.o open62541.o utils.o
server.o: server.c myNS.o open62541.o utils.o

...
attr.displayName = UA_LOCALIZEDTEXT("", "link6");
retVal |= UA_Server_addNode_begin(server, UA_NODECLASS_OBJECT,
UA_NODEID_NUMERIC(ns[1], 5007),
UA_NODEID_NUMERIC(ns[1], 1003),
UA_NODEID_NUMERIC(ns[0], 47),
UA_QUALIFIEDNAME(ns[1], "link6"),
UA_NODEID_NUMERIC(ns[1], 1002),
...
static UA_StatusCode function_myNS_55_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_55_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6021)
);
}
...
static UA_StatusCode function_myNS_56_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_56_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6019)
);
}
...
static UA_StatusCode function_myNS_57_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_57_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6020)
);
}
...
static UA_StatusCode function_myNS_58_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_58_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6014)
);
}
...
static UA_StatusCode function_myNS_59_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_59_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6017)
);
}
...
static UA_StatusCode function_myNS_60_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_60_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6016)
);
}
...
static UA_StatusCode function_myNS_61_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_61_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6015)
);
}
...
static UA_StatusCode function_myNS_62_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_myNS_62_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6012)
);
}
...
!(retVal = function_myNS_55_begin(server, ns)) &&
!(retVal = function_myNS_56_begin(server, ns)) &&
!(retVal = function_myNS_57_begin(server, ns)) &&
!(retVal = function_myNS_58_begin(server, ns)) &&
!(retVal = function_myNS_59_begin(server, ns)) &&
!(retVal = function_myNS_60_begin(server, ns)) &&
!(retVal = function_myNS_61_begin(server, ns)) &&
!(retVal = function_myNS_62_begin(server, ns)) &&
!(retVal = function_myNS_62_finish(server, ns)) &&
!(retVal = function_myNS_61_finish(server, ns)) &&
!(retVal = function_myNS_60_finish(server, ns)) &&
!(retVal = function_myNS_59_finish(server, ns)) &&
!(retVal = function_myNS_58_finish(server, ns)) &&
!(retVal = function_myNS_57_finish(server, ns)) &&
!(retVal = function_myNS_56_finish(server, ns)) &&
!(retVal = function_myNS_55_finish(server, ns)) &&
